/*-----------------------------------------------
 * 
 *    Projekt: Arduino Greenkeeper - Test Lichtsensor
 * 
 *    Name: Marvin Schmid
 * 
 *    Version: 0.1
...
Lichtsensor_Messwert = analogRead(Lichtsensor); //Die Spannung an dem Fotowiderstand auslesen und unter der Variable „sensorWert“ abspeichern.
Serial.print("Sensorwert = " ); //Ausgabe am Serial-Monitor: Das Wort „Sensorwert: „
Serial.println(Lichtsensor_Messwert); //Ausgabe am Serial-Monitor. Mit dem Befehl Serial.print wird der Sensorwert des Fotowiderstandes in Form einer Zahl zwischen 0 und 1023 an den serial monitor gesendet.
